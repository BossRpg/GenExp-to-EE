...
Gui Add, Text,, LVL Initial (1 to 9.999):
Gui, Add, Edit, w220 vLVInit1 number Limit4
Gui, Add, UpDown, vLVInit2 Range1-9999
...
{
	MsgBox, 0x30, Warn, The starting level cannot be equal to or higher than the maximum level!
	return
}
firstexp := ExpInit2
